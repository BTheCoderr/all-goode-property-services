    ...
    <section className="bg-[var(--color-cream)] py-16 sm:py-20">
      <Container>
        <SectionHeading
          ...
          subtitle="Real properties. Real work. Real results. Add new jobs in src/data/projects.ts — no layout changes needed."
        />
        ...
        <div className="mt-12 rounded-xl bg-[var(--color-ink)] p-8 text-[var(--color-cream)] sm:flex sm:items-center sm:justify-between">
          <div>
            <p className="font-display text-3xl tracking-tight">Got a mess like this?</p>
